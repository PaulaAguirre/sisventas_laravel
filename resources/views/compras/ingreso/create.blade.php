            ...
            <div class="panel-body">
                ...
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="number" name="pprecio_venta" id="pprecio_venta" placeholder="P. Venta" class="form-control">
                    </div>
                </div>
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                    <div class="form-group">
...
@push('scripts')
    <script>
        ...
        function agregar() {
             ...
             if(idarticulo!= "" && cantidad != "" && cantidad>0 && precio_compra != "" && precio_venta != 0){
                ...
                $('#detalles').append(fila);
                 ...
                 alert("Error al ingresar el detalle del venta, revise los datos del artículo");
             }
        }
