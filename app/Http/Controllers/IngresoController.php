...
class IngresoController extends Controller
{
        ...
        if ($request) {
            ...
            $ingresos = DB::table('ingreso as i')
                ...
                ->select('i.idingreso', 'i.fecha_hora', 'p.nombre','i.tipo_comprobante',
                    'i.serie_comprobante', 'i.num_comprobante', 'i.impuesto', 'i.estado', DB::raw('sum(di.cantidad*precio_compra) as total'))
    ...
    {
        $personas=DB::table('persona')->where('tipo','=','Proveedor')->get();
    ...
    public function store (IngresoFormRequest $request)
    {
        try{
            ...
            $mtyime= Carbon::now('America/Lima');
